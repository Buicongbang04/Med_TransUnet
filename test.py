...
#     help='checkpoint filename or full checkpoint path. Default: best_model.pth'
# )
...
#             'volume_path': 'data/LiTS/test_vol_h5',
...
#     if args.is_savenii:
#         args.test_save_dir = os.path.join(
#             args.output_dir,
#             'predictions'
#         )
...
parser.add_argument(
    ...
    type=int,
    default=1,
    help='whether use deterministic inference'
)
parser.add_argument(
    '--base_lr',
    type=float,
...
def inference(args, model, test_save_path=None):
    ...
    logging.info(
        'Testing performance: mean_dice : %f mean_hd95 : %f' %
...
if __name__ == "__main__":
    ...
    snapshot = resolve_checkpoint(args)
    logging.info(f'Loading checkpoint: {snapshot}')
